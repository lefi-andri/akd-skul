<div class="w3-row">
	<div class="w3-col s12 m12 l8">
		<h3>Mata Pelajaran <span class="w3-small"> / Manajemen mata pelajaran.</span></h3>
		<!-- with images -->
	</div>
	<div class="w3-col s12 m12 l4">
		<div class="w3-right" style="padding-top:20px;">
			<?php
				...
				echo anchor('mapel/add', '<i class="fa fa-user-plus"></i> Tambah Data', array('class' => 'w3-btn w3-small'));
...
<div class="w3-row">
	...
	<div class="w3-col s12 m12 l6">
		<form action="<?php echo site_url('mapel/search'); ?>" class="w3-container" method="post">
		<div class="w3-row">
		    ...
		    <div class="w3-col s3 m2 l2 w3-right">	
	            ...
	            if ($keyword <> '')
	            {
	                echo anchor('mapel', '<i class="fa fa-repeat"></i> Reset', array('class' => 'w3-btn-block w3-red w3-small'));
	            }
	            ?>
		    </div>
